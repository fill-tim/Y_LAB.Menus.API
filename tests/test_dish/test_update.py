...
async def test_update_dish_success(ac: AsyncClient, init_default_data) -> None:
...
async def test_update_dish_failed(ac: AsyncClient) -> None:
...
async def test_update_dish_failed_title(ac: AsyncClient, init_default_data) -> None:
    test_menu_id = init_default_data["test_menu_default"].id
    test_submenu_id = init_default_data["test_submenu_default"].id
    test_dish_id = init_default_data["test_dish_default"].id
...
async def test_update_dish_failed_description(
