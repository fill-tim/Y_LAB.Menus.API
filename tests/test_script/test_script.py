...
@pytest.mark.asyncio
async def test_check_the_number_of_dishes_and_submenus_in_menu(ac: AsyncClient) -> None:
    create_menu_url = await reverse_url('create_menu')
    ...
    create_submenu_url = await reverse_url('create_submenu', menu_id=menu_id)
    ...
    create_first_dish_url = await reverse_url(
        'create_dish', menu_id=menu_id, submenu_id=submenu_id
    )
    ...
    menu_url = await reverse_url('get_menu', menu_id=menu_id)
    ...
    submenu_url = await reverse_url('get_submenu', menu_id=menu_id, submenu_id=submenu_id)
    ...
    delete_submenu_url = await reverse_url(
        'delete_submenu', menu_id=menu_id, submenu_id=submenu_id
    )
    ...
    list_submenu_url = await reverse_url('list_submenu', menu_id=menu_id)
    ...
    list_dish_url = await reverse_url('list_dish', menu_id=menu_id, submenu_id=submenu_id)
    ...
    specific_menu_url = await reverse_url('get_menu', menu_id=menu_id)
    ...
    delete_menu_url = await reverse_url('delete_menu', menu_id=menu_id)
    ...
    list_menu_url = await reverse_url('list_menu')
