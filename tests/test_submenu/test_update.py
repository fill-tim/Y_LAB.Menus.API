...
async def test_update_submenu_success(ac: AsyncClient, init_default_data) -> None:
    ...
    url = await reverse_url(
        "update_submenu", menu_id=test_menu_id, submenu_id=test_submenu_id
    )
...
async def test_update_submenu_failed(ac: AsyncClient) -> None:
...
async def test_update_submenu_failed_title(ac: AsyncClient, init_default_data) -> None:
    test_menu_id = init_default_data["test_menu_default"].id
    test_submenu_id = init_default_data["test_submenu_default"].id
...
async def test_update_submenu_failed_description(
